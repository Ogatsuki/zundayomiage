 ...
 * @param shortTextLimit Limit for short text processing (default: 1000)
 * @param maxTextLimit Maximum allowed text length (default: 10000)
 * @returns Processing strategy and chunks if needed
 */
export function analyzeTextProcessing(
  text: string,
  shortTextLimit: number = 1000,
  maxTextLimit: number = 10000
): {
