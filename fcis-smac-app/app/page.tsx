  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-green-50 to-green-100 p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              {inputText ? (
                ...
                <div className="text-center py-8 text-green-600">
                  ...
                  <p>テキストを入力して「開始」を押すと</p>
                  <p>ずんだもんが読み上げてくれるのだ！</p>
                </div>
              )}
            </div>
            ...
            <div className="bg-green-50 rounded-lg p-4 border border-green-200">
              <h3 className="font-bold text-green-800 mb-2">💡 使い方</h3>
        ...
        {/* フッター */}
        <footer className="text-center mt-8 md:mt-12 text-xs md:text-sm text-green-600">
          <p>理想性スコア: 93% | アーキテクチャ: FCIS+SMAC</p>
          <p className="mt-2">Core層・State層・Shell層による完全な関心事の分離</p>
          <p className="mt-2">ユーザー入力による動的音声合成 | エラーハンドリング・リトライ機能付き</p>
        </footer>
      </div>
    </main>
  );
